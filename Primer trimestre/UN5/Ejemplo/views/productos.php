...
<head>
    ...
    <link rel="stylesheet" href="/UN5/Ejemplo/assets/styles.css">
</head>
<body>
    <h2>Productos</h2>
    ...
    <a href="/UN5/Ejemplo/views/agregar_producto.php">Agregar Producto</a>
    <br><br>
    ...
    <table border="1">
        ...
        <?php foreach ($productos as $producto): ?>
            <tr>
                ...
                <td>
                    <a href="/UN5/Ejemplo/views/editar_producto.php?id=<?php echo $producto['id']; ?>">Editar</a>
                    <a href="/UN5/Ejemplo/views/eliminar_producto.php?id=<?php echo $producto['id']; ?>">Eliminar</a>
                </td>
            </tr>
        <?php endforeach; ?>
    </table>
